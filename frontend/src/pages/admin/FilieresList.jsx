...
import { Plus, Search, Layers, Edit, Trash2, X, Save, AlertTriangle } from 'lucide-react';
...
const FilieresList = () => {
    ...
    const promptDelete = (id) => {
        setConfirmModal({
            ...
            message: "Êtes-vous sûr de vouloir supprimer cette filière ? Elle est peut-être liée à d'autres données.",
            isDestructive: true,
                                    ...
                                    <tr key={filiere.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button 
                                                    onClick={() => promptDelete(filiere.id)}
                    ...
                    <div className="bg-white rounded-[2rem] w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                            ...
                            <div className="pt-4 mt-6 border-t border-slate-100 flex items-center justify-end gap-3">
                                ...
                                <button type="submit" disabled={isSubmitting} className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-purple-600/20 flex items-center gap-2">
                                    {isSubmitting ? (
